 ...
 * });
 */
exports.statusCodeNames = Object.fromEntries(Object.entries(EStatusCode).map(function (_a) {
...
var isValidStatusCode = function (code) {
    return Object.values(EStatusCode).includes(Number(code)) || Object.values(exports.statusCodeNames).includes(String(code));
};
