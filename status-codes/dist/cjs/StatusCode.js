 ...
 */
var requiresAuthentication = function (code) { return code === StatusCode.CLIENT_ERROR_UNAUTHORIZED; };
exports.requiresAuthentication = requiresAuthentication;
/**
 * Checks if status code indicates resource not found
 */
var isNotFound = function (code) { return code === StatusCode.CLIENT_ERROR_NOT_FOUND; };
exports.isNotFound = isNotFound;
/**
 * Checks if status code indicates rate limiting
 */
var isRateLimited = function (code) { return code === StatusCode.CLIENT_ERROR_TOO_MANY_REQUESTS; };
